...
const createAchievements = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const achievement = yield achievements_service_1.AchievementsService.createAchievements(achievementsData);
...
const updateAchievements = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield achievements_service_1.AchievementsService.updateAchievements(achievementId, achievementsData);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
