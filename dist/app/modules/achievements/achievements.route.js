...
router.post('/', achievements_controller_1.AchievementsController.createAchievements);
...
router.patch('/:id', achievements_controller_1.AchievementsController.updateAchievements);
