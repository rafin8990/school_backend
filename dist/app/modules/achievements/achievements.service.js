...
const createAchievements = (achievements, file) => __awaiter(void 0, void 0, void 0, function* () {
    if (!file) {
...
const updateAchievements = (id, updateData, file) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (file) {
